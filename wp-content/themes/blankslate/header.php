...
<script>(function (d, s, id) {
        ...
        js.id = id;
        js.src = "//connect.facebook.net/en_US/all.js#xfbml=1&appId=130737060408324";
        fjs.parentNode.insertBefore(js, fjs);
    }(document, 'script', 'facebook-jssdk'));</script>
<div id="wrapper" class="hfeed">
    <header>
        <div id="branding" class="row">
            <div id="site-logo" class="span2"><a href="<?php echo home_url(); ?>"><img
                        src="<?php echo home_url(); ?>/images/cornerlogo.gif"/></a></div>
            ...
            <div id="nav-tools" class="span4">
                ...
                <div id="social-icons-wrapper">
                    <div id="facebook-icon" class="social-icon"><a href=""><img
                                src="<?php echo home_url(); ?>/images/home_06.png"/></a></div>
                    <div id="yelp-icon" class="social-icon"><a href=""><img
                                src="<?php echo home_url(); ?>/images/home_08.png"/></a></div>
                </div>
                <div id="search">
                    <?php get_search_form(); ?>
                </div>
    ...
    <div id="responsive-buttons" class="row-fluid">
        ...
        <div id="openCallDialog" class="popup">
            <div>
                ...
                <button id="call-slo" class="button phone-button" onclick='location.href="tel:8053491300"'>Call San Luis
                    Obispo Location
                </button>
                <button id="call-sm" class="button phone-button" onclick='location.href="tel:8055416090"'>Call Santa
                    Maria Location
                </button>
            </div>
        </div>
